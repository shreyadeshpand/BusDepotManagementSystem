...
<html lang="en">
  ...
  <div class="form-group">
    ...
    <input type="text" name="rid" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Route ID" value =<?php
    echo $rid;
    ?> readonly>
  ...
  <div class="form-group">
    ...
    <input type="text" name="source" class="form-control" id="exampleInputPassword1" placeholder="Source" value =<?php
    echo $source;
    ?>>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Destination</label>
    <input type="text" name = "destination" class="form-control" id="exampleInputPassword1" placeholder="destination" value =<?php
    echo $destination;
    ?>>
  </div>
...
<input type="text" id="stops" name="stops" class="form-control" value="<?php echo $stops_string; ?>">
